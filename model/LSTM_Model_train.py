...
# model_checkpoint = ModelCheckpoint(os.path.join(folder_name, f"{symbol}_model.keras"), save_best_only=True)
...
# model.save(os.path.join(folder_name, f"{symbol}_model.keras"))

# # Save the scaler and data
# joblib.dump(scaler, os.path.join(folder_name, f"{symbol}_scaler.pkl"))
# np.save(os.path.join(folder_name, f"{symbol}_x_train.npy"), x_train)
# np.save(os.path.join(folder_name, f"{symbol}_y_train.npy"), y_train)
# np.save(os.path.join(folder_name, f"{symbol}_x_test.npy"), x_test)
# np.save(os.path.join(folder_name, f"{symbol}_y_test.npy"), y_test)
